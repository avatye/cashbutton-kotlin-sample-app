...
class RewardInterstitialAdActivity: AppCompatActivity() {
    ...
    companion object {
        val TAG: String = RewardInterstitialAdActivity::class.java.simpleName
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        interstitialAdLoader = InterstitialAdLoader(
            ownerActivity = this,
            placementId = getString(R.string.adcash_open_reward_interstitial_baaner_pid),
            listener = object : InterstitialAdLoader.InterstitialListener {
                ...
                override fun onFailed(error: AdError) {
                    ...
                    Toast.makeText(this@RewardInterstitialAdActivity, error.errorMessage, Toast.LENGTH_SHORT).show()
                }
